        ...
        <nav className="flex justify-between items-center py-5 px-1.5 fixed w-screen">
            ...
            <div>
                ...
                <ul className={`flex max-md:flex-col max-md:gap-2 max-md:bg-gray-800 max-md:py-2 max-md:w-32 max-md:text-center max-md:fixed ${isDropped ? 'transition-all max-md:top-20' : 'transition-all max-md:-top-48'} right-4 rounded gap-5 list-none`}>
                    <li className="max-md:px-3 max-md:border-b-2 last:border-b-0 max-md:pb-2 leading-loose"><Link href={'/posts'} className={`focus:active:tracking-wider`}>Posts</Link></li>
                    <li className="max-md:px-3 max-md:border-b-2 last:border-b-0 max-md:pb-2 leading-loose"><Link href={'/mutation'} className={`focus:active:tracking-wider`}>New Post</Link></li>
